...
public class S3Service implements FileService
{
    ...
    public String uploadFile(MultipartFile file)
   {
      //upload file to AWS S3
       ...
       try
        {
           awsS3Client.putObject( YOUTUBE_CLONE,key,file.getInputStream(),metadata);
        }
       catch (IOException e)
       {
       ...
       awsS3Client.setObjectAcl(YOUTUBE_CLONE,key, CannedAccessControlList.PublicRead);
       return awsS3Client.getResourceUrl(YOUTUBE_CLONE,key);
